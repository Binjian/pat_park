...
function draw_compatibility (prediction, observations, compatibility,configuration)
%-------------------------------------------------------
...
if configuration.step_by_step
    ...
    %draw vehicle
    draw_vehicle(vehicle.x, vehicle.P, 'r',configuration);
